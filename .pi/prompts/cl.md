...
Attribution:
- Internal: `Fixed foo ([#123](https://github.com/FuzzyFade/open-pi/issues/123))`
- External: `Added bar ([#456](https://github.com/FuzzyFade/open-pi/pull/456) by [@user](https://github.com/user))`
