...
tmux send-keys -t pi-test "cd /Users/FuzzyFade/workspaces/pi-mono && ./pi-test.sh" Enter
...
### Attribution
- **Internal changes (from issues)**: `Fixed foo bar ([#123](https://github.com/FuzzyFade/open-pi/issues/123))`
- **External contributions**: `Added feature X ([#456](https://github.com/FuzzyFade/open-pi/pull/456) by [@username](https://github.com/username))`
