...
import type { AgentMessage, AgentToolResult, AgentToolUpdateCallback, ThinkingLevel } from "open-pi-agent";
import type {
	Api,
...
export interface ExtensionUIContext {
	 ...
	 * extend `CustomEditor` from `open-pi-coding-agent` and call
	 * `super.handleInput(data)` for keys you don't handle.
	 *
	 * @example
	 * ```ts
	 * import { CustomEditor } from "open-pi-coding-agent";
	 *
