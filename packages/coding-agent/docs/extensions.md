...
- [read.ts](https://github.com/FuzzyFade/open-pi/blob/main/packages/coding-agent/src/core/tools/read.ts) - `ReadToolDetails`
- [bash.ts](https://github.com/FuzzyFade/open-pi/blob/main/packages/coding-agent/src/core/tools/bash.ts) - `BashToolDetails`
- [edit.ts](https://github.com/FuzzyFade/open-pi/blob/main/packages/coding-agent/src/core/tools/edit.ts)
- [write.ts](https://github.com/FuzzyFade/open-pi/blob/main/packages/coding-agent/src/core/tools/write.ts)
- [grep.ts](https://github.com/FuzzyFade/open-pi/blob/main/packages/coding-agent/src/core/tools/grep.ts) - `GrepToolDetails`
- [find.ts](https://github.com/FuzzyFade/open-pi/blob/main/packages/coding-agent/src/core/tools/find.ts) - `FindToolDetails`
- [ls.ts](https://github.com/FuzzyFade/open-pi/blob/main/packages/coding-agent/src/core/tools/ls.ts) - `LsToolDetails`
...
Tools can provide `renderCall` and `renderResult` for custom TUI display. See [tui.md](tui.md) for the full component API and [tool-execution.ts](https://github.com/FuzzyFade/open-pi/blob/main/packages/coding-agent/src/modes/interactive/components/tool-execution.ts) for how built-in tools render.
