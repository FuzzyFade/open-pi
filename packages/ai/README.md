...
TypeBox exports are re-exported from `open-pi-ai`: `Type`, `Static`, and `TSchema`.

## Quick Start

```typescript
import { Type, getModel, stream, complete, Context, Tool, StringEnum } from 'open-pi-ai';
...
```typescript
import { Type, Tool, StringEnum } from 'open-pi-ai';
...
```typescript
import { stream, validateToolCall, Tool } from 'open-pi-ai';
...
```typescript
import { readFileSync } from 'fs';
import { getModel, complete } from 'open-pi-ai';
...
```typescript
import { getModel, streamSimple, completeSimple } from 'open-pi-ai';
...
```typescript
import { getModel, stream } from 'open-pi-ai';
...
```typescript
import { getProviders, getModels, getModel } from 'open-pi-ai';
...
```typescript
import { Model, stream } from 'open-pi-ai';
...
```typescript
import { streamAnthropic, type AnthropicOptions } from 'open-pi-ai';
...
```typescript
import { getModel, complete, Context } from 'open-pi-ai';
...
```typescript
import { Context, getModel, complete } from 'open-pi-ai';
...
- OAuth login flows are not supported in browser environments. Use the `open-pi-ai/oauth` entry point in Node.js.
...
```typescript
import { getEnvApiKey } from 'open-pi-ai';
...
```bash
npx open-pi-ai login              # interactive provider selection
npx open-pi-ai login anthropic    # login to specific provider
npx open-pi-ai list               # list available providers
```
...
The library provides login and token refresh functions via the `open-pi-ai/oauth` entry point. Credential storage is the caller's responsibility.
...
} from 'open-pi-ai/oauth';
```

### Login Flow Example

```typescript
import { loginGitHubCopilot } from 'open-pi-ai/oauth';
...
```typescript
import { getModel, complete } from 'open-pi-ai';
import { getOAuthApiKey } from 'open-pi-ai/oauth';
