...
```bash
npm install open-pi-web-ui open-pi-agent open-pi-ai
```
...
```typescript
import { Agent } from 'open-pi-agent';
...
```typescript
import { defaultConvertToLlm, convertAttachments } from 'open-pi-web-ui';
...
```typescript
import { createJavaScriptReplTool } from 'open-pi-web-ui';
...
```typescript
import { createExtractDocumentTool } from 'open-pi-web-ui';
...
```typescript
import { registerToolRenderer, type ToolRenderer } from 'open-pi-web-ui';
...
```typescript
import { loadAttachment, type Attachment } from 'open-pi-web-ui';
...
```typescript
import { createStreamFn, shouldUseProxyForProvider, isCorsError } from 'open-pi-web-ui';
...
```typescript
import { SettingsDialog, ProvidersModelsTab, ProxyTab, ApiKeysTab } from 'open-pi-web-ui';
...
```typescript
import { SessionListDialog } from 'open-pi-web-ui';
...
```typescript
import { ApiKeyPromptDialog } from 'open-pi-web-ui';
...
```typescript
import { ModelSelector } from 'open-pi-web-ui';
...
```css
@import '@FuzzyFade/mini-lit/themes/claude.css';
@tailwind base;
@tailwind components;
@tailwind utilities;
```
...
```typescript
import { i18n, setLanguage, translations } from 'open-pi-web-ui';
