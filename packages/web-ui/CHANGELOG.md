...
- Made model selector search case-insensitive by normalizing query tokens, fixing auto-capitalized mobile input filtering ([#1443](https://github.com/FuzzyFade/open-pi/issues/1443))
...
- Exported `CustomProviderCard`, `ProviderKeyInput`, `AbortedMessage`, and `ToolMessageDebugView` components for custom UIs ([#1015](https://github.com/FuzzyFade/open-pi/issues/1015))
...
- Updated tsgo to 7.0.0-dev.20260120.1 for decorator support ([#873](https://github.com/FuzzyFade/open-pi/issues/873))
