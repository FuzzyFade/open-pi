import { defaultEnglish, defaultGerman, type MiniLitRequiredMessages, setTranslations } from "@FuzzyFade/mini-lit";

declare module "@FuzzyFade/mini-lit" {
...
export * from "@FuzzyFade/mini-lit/dist/i18n.js";
